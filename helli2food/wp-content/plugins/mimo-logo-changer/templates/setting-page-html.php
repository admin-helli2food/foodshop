<div class="wrap">
    <h1 class="wp-heading-inline"><?php _e('Logo Changer - Setting', 'mimo-logo-changer'); ?></h1>

    <form action="" method="POST" class="lc-form-inline">
        <button name="lc_reset_setting" type="submit" onclick="return lc_check_for_reset_setting()" class="page-title-action"><?php _e('Return to default settings', 'mimo-logo-changer'); ?></button>
    ...
    <div class="metabox-holder has-right-sidebar" id="poststuff">
        ...
        <div id="post-body">
            <div id="post-body-content">
                ...
                <div class="postbox">
                    <h3><?php _e('Setting', 'mimo-logo-changer'); ?></h3>
                    <div class="inside">
                        <form method="POST" action="">
                            <table class='form-table'>
                                <tr valign="top">
                                    <th scope="row"><?php _e('Logo', 'mimo-logo-changer'); ?>:</th>
                                    <td>
                                        ...
                                        <input id="upload_image_button" type="button" class="button" value="<?php _e('Choose or Upload Photo', 'mimo-logo-changer'); ?>" />
                                    ...
                                    jQuery(document).ready(function ($) {
                                        ...
                                        jQuery('#upload_image_button').on('click', function (event) {
                                            ...
                                            file_frame = wp.media.frames.file_frame = wp.media({
                                                title: '<?php _e('Select a image to upload', 'mimo-logo-changer'); ?>',
                                                button: {
                                                    text: '<?php _e('Use this image', 'mimo-logo-changer'); ?>',
                                                },
                                ...
                                <tr>
                                    <th scope="row"> <?php _e('Logo Width', 'mimo-logo-changer'); ?> :</th>
                                ...
                                <tr>
                                    <th scope="row"> <?php _e('Logo Height', 'mimo-logo-changer'); ?> :</th>
                                ...
                                <tr valign="top">
                                    <th scope="row"><?php _e('Logo Link', 'mimo-logo-changer'); ?> : </th>
                                ...
                                <tr valign="top">
                                    <th scope="row"><?php _e('Logo Title', 'mimo-logo-changer'); ?> : </th>
                                ...
                                <tr valign="top">
                                    <th scope="row"><?php _e('Message shows in login page', 'mimo-logo-changer'); ?> : </th>
                                    <td><input
                                ...
                                <tr valign="top">
                                    <th scope="row"><?php _e('I want use custom HTML code!'); ?></th>
                                ...
                                <tr valign="top" id="lc_custom_html_message_container" class="<?php echo intval(get_option('mlchanger_custom_html_message_bool')) ? '' : 'lc_display_none' ?>">
                                    <th scope="row"><?php _e('Custom HTML code'); ?> </th>
                                    <td>
                                ...
                                <tr valign="top">
                                    <th scope="row"> <?php _e('Remove Wordpress Icon in navbar?(Need Refresh)', 'mimo-logo-changer'); ?></th>
                            ...
                            submit_button(translate('Save Changes', 'mimo-logo-changer'));
                            ?>
                        </form>
                    </div>
        ...
        <div class="inner-sidebar" id="side-info-column">
            <div class="postbox">
                <h3><?php _e('Login Page Current Status', 'mimo-logo-changer'); ?></h3>
                <div class="inside lc-preview">
                    ...
                    <p>
                        <i><?php _e('Real Logo Size', 'mimo-logo-changer'); ?>:</i><br>
                        <i><?php _e('Width', 'mimo-logo-changer'); ?>: </i><b><?php echo !empty(get_option('mlchanger_img_width')) ? get_option('mlchanger_img_width') : '84'; ?></b>px<br>
                        <i><?php _e('Height', 'mimo-logo-changer'); ?>: </i><b><?php echo !empty(get_option('mlchanger_img_height')) ? get_option('mlchanger_img_height') : '84'; ?></b>px
                    </p>
                </div>
            </div>
        </div>
